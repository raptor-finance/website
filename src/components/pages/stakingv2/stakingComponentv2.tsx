...
class StakingComponentv2 extends BaseComponent<StakingProps & WithTranslation, StakingState> {
			...
			<div className="container">
				<div className="row text-white staking-header">
					<div className="col-md-12">
						...
						<p><Trans i18nKey='staking.paragraph2'>In order to unstake Raptor tokens, you need to connect your browser wallet (such as <a
							href="https://metamask.io/">Metamask</a>) and <a
								href="https://academy.binance.com/en/articles/connecting-metamask-to-binance-smart-chain"
								target="_blank">Switch to the Binance Smart Chain</a></Trans>.
						</p>
												<p>
							<font size="6" color="red">Please, unstake your Raptor V2 tokens and <u><NavLink to="/migrate" activeClassName="active">migrate</NavLink></u> them to Raptor V3</font>
						</p>
					</div>
				</div>
...
export default withTranslation()(StakingComponentv2);