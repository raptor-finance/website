        ...
        <div className="d-flex flex-row container">
            <div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <h1><span>{t('about.raptor_finance.title')}</span><img src="images/lsolo-logo.svg" /></h1>
                                ...
                                <h1><span>{t('about.products_overview.title')}</span><img src="images/lsolo-logo.svg" /></h1>
                ...
                <section id="team">
                    <div className="container" id="team-members">
                        <div id="team-header">
                            <h1><span>{t('about.team.title')}</span><img src="images/lsolo-logo.svg" /></h1>
                        </div>
                        <div className="row">
                ...
                <section id="roadmap">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <h1><span>{t('about.our_roadmap.title')}</span><img src="images/lsolo-logo.svg" /></h1>
            ...
            <div className="d-none d-lg-flex sticky-top col-3" id="sidebar">
                <div className="align-self-start gradient-card primary">
                    ...
                    <h5>{t('about.card_right.title')}</h5>
                    <p>{t('about.card_right.desc')}</p><a className="link-dark" href="#mission">{t('about.card_right.mission')}</a><a className="link-dark" href="#team">{t('about.card_right.team')}</a><a className="link-dark" href="#roadmap">{t('about.card_right.roadmap')}</a>
                </div>
            </div>
        </div>
    </div>
