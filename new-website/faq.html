    ...
    <div class="navigation-wrapper">
        ...
        <nav id="left-navbar">
            <ul>
                ...
                <li>
                    <a href="faq.html" class="nav-item-faq active">FAQ</a>
                </li>
<!--                <li>-->
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div>
                            <p class="text-white mb-5">
                                We are currently collecting the frequent questions to display here. Meanwhile, please ask your question in the Telegram channel!
                            </p>
                        </div>
                    </div>
                </div>
